...
const projects: Project[] = [
  {
    ...
    description: 'AI-based gamified platform with interactive UI & progress tracking.',
    techTags: ['React', 'Firebase', 'AI', 'Tailwind'],
    imageUrl: 'https://images.pexels.com/photos/3861943/pexels-photo-3861943.jpeg?auto=compress&cs=tinysrgb&w=600',
